  ...
  return (
    ...
    <div className="min-h-screen bg-white py-16 text-black">
      <div className="mx-auto flex max-w-7xl flex-col gap-10 px-4 sm:px-6 lg:px-8">
        ...
        {/* ===== FEATURED SECTION ===== */}
        <section className="rounded-3xl border border-gray-200 bg-gradient-to-br from-[#0070f3]/8 to-[#7928ca]/8 p-8 sm:p-12 hover:shadow-lg transition-shadow">
          <div className="max-w-3xl">
            ...
            <Link
              ...
              className="mt-6 inline-flex items-center gap-2 text-white bg-[#0070f3] px-6 py-3 rounded-lg font-medium hover:bg-[#0070f3]/90 transition-colors"
            >
              Read Featured Post
        ...
        <div className="grid gap-6 lg:grid-cols-[1.4fr_0.8fr]">
          ...
          <div>
            ...
            <div className="relative mb-6">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-200 bg-white py-2.5 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#0070f3]/20 focus:border-[#0070f3]"
              />
            </div>
            
            <div className="space-y-4">
              {posts.map((post) => (
                <article key={post.id} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm hover:shadow-lg transition-shadow">
                  ...
                  <h2 className="text-xl font-semibold text-gray-900 hover:text-[#0070f3] transition-colors">
          ...
          <aside className="space-y-4">
            {/* Categories */}
            <div className="space-y-4 rounded-2xl border border-gray-200 bg-gray-50 p-6 hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2">
                {categories.map((category) => (
                  <div
                    key={category.name}
                    className="flex items-center justify-between rounded-lg bg-white p-3 border border-gray-100 hover:border-[#0070f3] transition-colors"
                  >
            ...
            <div className="space-y-4 rounded-2xl border border-gray-200 bg-gray-50 p-6 hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2">
                {authors.map((author) => (
                  <div key={author.name} className="flex items-center gap-3 rounded-lg bg-white p-3 border border-gray-100 hover:border-[#0070f3] transition-colors">
