      ...
      <div className="bg-white px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 max-w-3xl">
            ...
            <h1 className="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Events designed to spark learning and connection</h1>
            <p className="mt-4 text-lg text-gray-600">From industry talks to build sprints, our events give members a chance to learn, network, and grow in public.</p>
          </div>
            ...
            {cards.map((card) => {
              ...
              return (
                <Link key={card.title} href={card.href} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl">
                  ...
                  {card.badge && <span className="mb-3 inline-flex rounded-full bg-[#0070f3]/10 px-2.5 py-1 text-xs font-medium text-[#0070f3]">{card.badge}</span>}
          ...
          <div className="mt-12 flex flex-wrap gap-4">
            ...
            <Link href="/contact" className="inline-flex items-center rounded-full border border-gray-300 px-6 py-3 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50">
