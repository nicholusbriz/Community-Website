        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:px-8">
          <section className="rounded-3xl border border-gray-200 bg-linear-to-br from-[#0070f3]/8 to-[#7928ca]/8 p-8 sm:p-12">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Frequently asked questions about Tech Rise Africa</h1>
              <p className="mt-5 text-lg leading-8 text-gray-600">A clear starting point for newcomers, members, mentors, and partners who want to understand how the community works.</p>
            </div>
          </section>
