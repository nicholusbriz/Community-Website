        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:px-8">
          ...
          <section className="rounded-3xl border border-gray-200 bg-gradient-to-br from-[#0070f3]/8 to-[#7928ca]/8 p-8 sm:p-12">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-lg leading-8 text-gray-600">This gallery highlights the energy, outcomes, and connections that make Tech Rise Africa a vibrant place to learn and build.</p>
            </div>
          </section>
