        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:px-8">
          <section className="rounded-3xl border border-gray-200 bg-linear-to-br from-[#0070f3]/8 to-[#7928ca]/8 p-8 sm:p-12">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-lg leading-8 text-gray-600">Join an active community of learners, builders, mentors, and volunteers who are creating real solutions together.</p>
            </div>
          </section>
          ...
          <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
              ...
              <div className="mt-8 space-y-4">
                {steps.map((step, index) => (
                  <div key={step.title} className="flex gap-3 rounded-xl border border-gray-200 bg-gray-50 p-4">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#0070f3] text-sm font-semibold text-white">{index + 1}</div>
                    <div>
            ...
            <aside className="space-y-4 rounded-2xl border border-gray-200 bg-gray-50 p-6">
              <div className="rounded-xl border border-gray-200 bg-white p-5">
                ...
                <p className="mt-3 text-sm leading-7 text-gray-600">Respect, collaboration, growth, and inclusion are the foundation of everything we do together.</p>
              </div>
              <div className="rounded-xl border border-gray-200 bg-white p-5">
                <div className="flex items-center gap-2 text-[#0070f3]">
                ...
                <p className="mt-3 text-sm leading-7 text-gray-600">Learn, build, mentor, volunteer, or support community projects at your own pace.</p>
              </div>
              <Link href="/contact" className="inline-flex items-center gap-2 rounded-full bg-black px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-gray-800">
                Contact the team
