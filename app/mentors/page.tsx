        ...
        <section className="rounded-3xl border border-gray-200 bg-gradient-to-br from-[#0070f3]/8 to-[#7928ca]/8 p-8 sm:p-12">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
              Meet the people guiding the next generation of builders
            </h1>
            <p className="mt-5 text-lg leading-8 text-gray-600">
              Mentors, volunteers, and organizers are at the heart of Tech Rise Africa. 
              They help new members learn, build, and connect with confidence.
            </p>
          </div>
        </section>

        {/* Mentors Grid + Sidebar */}
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          {/* Mentors List */}
          <div className="space-y-4">
            {mentors.map((mentor) => (
              <div key={mentor.name} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#0070f3]/10 to-[#7928ca]/10 text-lg font-semibold text-[#0070f3]">
