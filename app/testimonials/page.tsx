        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:px-8">
          <section className="rounded-3xl border border-gray-200 bg-linear-to-br from-[#0070f3]/8 to-[#7928ca]/8 p-8 sm:p-12">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-lg leading-8 text-gray-600">These stories reflect the practical support, mentorship, and momentum that members experience inside Tech Rise Africa.</p>
            </div>
          </section>
            ...
            {testimonials.map((testimonial) => (
              <div key={testimonial.name} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-6 flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-linear-to-br from-[#0070f3]/10 to-[#7928ca]/10 text-sm font-semibold text-[#0070f3]">
          ...
          <section className="rounded-2xl border border-gray-200 bg-gray-50 p-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-gray-600">If you have grown through the community, we would love to feature your journey as part of our next highlight.</p>
              </div>
              <div className="flex flex-wrap gap-3">
                <a href="mailto:hello@techriseafrica.org" className="inline-flex items-center gap-2 rounded-full bg-black px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-gray-800">
                  <BadgeCheck className="h-4 w-4" />
                  Share your story
                </a>
                <a href="/community" className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50">
