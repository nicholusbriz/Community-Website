...
const stories = [
  {
    ...
    content: 'Developers Ecosystem transformed my career. The mentorship program connected me with industry leaders who helped me grow from a junior developer to leading teams at Google.',
    rating: 5,
    avatar: 'AO',
  ...
  },
  {
    ...
    content: 'The startup ecosystem at Developers Ecosystem is unmatched. We found our first investors, built our MVP, and launched to 10K users in just 6 months.',
    rating: 5,
    avatar: 'GM',
  ...
  },
  {
    ...
    content: 'I learned more in one year with Developers Ecosystem than in my entire university education. The hands-on projects and community support are incredible.',
    rating: 5,
    avatar: 'SK',
