...
import { serverAuthMiddleware } from './auth/server'
import { publicRoutes, authRoutes, apiAuthRoutes } from './routes/public'
import { protectedRoutes } from './routes/protected'
import { adminRoutes, superAdminRoutes } from './routes/admin'
...
export async function middleware(request: NextRequest) {
  ...
  const { token, isAuthenticated, user } = await serverAuthMiddleware(request)
